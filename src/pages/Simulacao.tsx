    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 border border-slate-200 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 p-6 shadow-sm">
          <h3 className="text-xs font-bold text-slate-400 mb-6">Parâmetros</h3>
          <div className="space-y-5">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-500 mb-2">Salário Base Atual (Kz)</label>
              <input
                readOnly
            ...
            <div>
              <label className="block text-xs font-bold text-primary mb-2">Novo Salário — Cenário (Kz)</label>
              <input
                type="text"
            ...
            <button
              ...
              className="w-full bg-primary text-white py-4 rounded-xl text-xs font-bold shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all disabled:opacity-50"
            >
              {loading ? (
        ...
        <div className="lg:col-span-2 space-y-6">
          {!result ? (
            <div className="glass-card p-12 flex flex-col items-center justify-center min-h-[350px] text-center">
              ...
              <p className="text-slate-400 font-bold text-xs">Selecione um colaborador e clique em "Calcular"</p>
            </div>
          ) : (
            <>
              {/* Cards de Custos */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="glass-card p-5 border-b-4 border-b-slate-400">
                  <p className="text-xs font-bold text-slate-400 mb-2">Custo Atual (Empresa)</p>
                ...
                <div className="glass-card p-5 border-b-4 border-b-amber-500">
                  <p className="text-xs font-bold text-amber-500 mb-2">Novo Custo Estimado</p>
                ...
                <div className="glass-card p-5 border-b-4 border-b-red-500 bg-red-50 dark:bg-red-900/10">
                  <p className="text-xs font-bold text-red-600 mb-2">Impacto Mensal Extra</p>
              ...
              <div className="glass-card p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-primary/5 border-2 border-primary/30 rounded-xl p-5 space-y-2">
                    <p className="text-xs text-primary font-bold">Novo Cenário</p>
              ...
              <div className="glass-card p-5 flex gap-3">
                <button className="flex-1 bg-emerald-500 text-white py-4 rounded-xl text-xs font-bold shadow-lg shadow-emerald-500/20 hover:bg-emerald-600 transition-all">
                  Aprovar Aumento
                </button>
                <button
                  onClick={() => { setResult(null); }}
                  className="bg-slate-100 dark:bg-slate-800 text-slate-500 px-8 py-4 rounded-xl text-xs font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-all"
                >
                  Recalcular
                </button>
              </div>
